...
class widget_textads extends WP_Widget {
	function widget_textads() {
		$widget_ops = array( 'classname' => 'widget_textads', 'description' => '显示一个文本特别推荐' );
		$this->WP_Widget( 'widget_textads', 'D-特别推荐', $widget_ops );
	}
	...
	function form($instance) {
		$defaults = array( 
			...
			'link' => 'http://www.daqianduan.com/theme/xiu', 
			'style' => 'style01'
		);
