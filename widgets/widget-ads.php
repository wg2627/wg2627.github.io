...
class widget_ads extends WP_Widget {
	function widget_ads() {
		...
		$this->WP_Widget( 'widget_ads', 'D-'.__('广告', 'haoui'), $widget_ops );
	}
	...
	function form($instance) {
		$defaults = array( 
			...
			'code' => '<a href="http://www.alibaixiu.com" target="_blank"><img src="http://www.daqianduan.com/wp-content/uploads/2014/09/alibaixiu.png"></a>' 
		);
